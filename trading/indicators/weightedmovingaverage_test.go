...
func TestWeightedMovingAverageUpdateEntity(t *testing.T) { //nolint: funlen
	...
	t.Run("update scalar", func(t *testing.T) {
		...
		s := data.Scalar{Time: time, Value: input[1]}
	...
	t.Run("update bar", func(t *testing.T) {
		...
		b := data.Bar{Time: time, Close: input[1]}
		wma := testWeightedMovingAverageCreate(l)
		wma.Update(input[0])
	...
	t.Run("update quote", func(t *testing.T) {
		...
		q := data.Quote{Time: time, Bid: input[1]}
		wma := testWeightedMovingAverageCreate(l)
		wma.Update(input[0])
	...
	t.Run("update trade", func(t *testing.T) {
		...
		r := data.Trade{Time: time, Price: input[1]}
		wma := testWeightedMovingAverageCreate(l)
		wma.Update(input[0])
...
func TestWeightedMovingAverageMetadata(t *testing.T) {
	...
	check("Type", indicator.WeightedMovingAverage, act.Type)
	...
	check("Outputs[0].Name", "wma(5)", act.Outputs[0].Name)
...
func TestNewWeightedMovingAverage(t *testing.T) { //nolint: funlen
	...
	t.Run("length > 1", func(t *testing.T) {
		...
		check("name", "wma(5)", wma.name)
		check("description", "Weighted moving average wma(5)", wma.description)
		...
		check("barFunc == nil", false, wma.barFunc == nil)
		check("quoteFunc == nil", false, wma.quoteFunc == nil)
		check("tradeFunc == nil", false, wma.tradeFunc == nil)
	})
