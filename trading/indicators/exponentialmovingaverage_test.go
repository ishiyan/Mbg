...
//nolint: funlen
func TestExponentialMovingAverageUpdateEntity(t *testing.T) {
	t.Parallel()
...
func TestNewExponentialMovingAverage(t *testing.T) {
	...
	t.Run("invalid bar component", func(t *testing.T) {
		t.Parallel()
		params := ExponentialMovingAverageSmoothingFactorParams{
			SmoothingFactor: 1, FirstIsAverage: true, BarComponent: data.BarComponent(9999), QuoteComponent: qc, TradeComponent: tc,
		}
	...
	t.Run("invalid quote component", func(t *testing.T) {
		t.Parallel()
		params := ExponentialMovingAverageSmoothingFactorParams{
			SmoothingFactor: 1, FirstIsAverage: true, BarComponent: bc, QuoteComponent: data.QuoteComponent(9999), TradeComponent: tc,
		}
	...
	t.Run("invalid trade component", func(t *testing.T) {
		t.Parallel()
		params := ExponentialMovingAverageSmoothingFactorParams{
			SmoothingFactor: 1, FirstIsAverage: true, BarComponent: bc, QuoteComponent: qc, TradeComponent: data.TradeComponent(9999),
		}
