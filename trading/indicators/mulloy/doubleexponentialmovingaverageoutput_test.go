...
func TestDoubleExponentialMovingAverageOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{DoubleExponentialMovingAverageValue, doubleExponentialMovingAverageValue},
		{doubleExponentialMovingAverageLast, doubleExponentialMovingAverageUnknown},
		{DoubleExponentialMovingAverageOutput(0), doubleExponentialMovingAverageUnknown},
		{DoubleExponentialMovingAverageOutput(9999), doubleExponentialMovingAverageUnknown},
		{DoubleExponentialMovingAverageOutput(-9999), doubleExponentialMovingAverageUnknown},
	}
...
func TestDoubleExponentialMovingAverageOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{DoubleExponentialMovingAverageValue, dqs + doubleExponentialMovingAverageValue + dqs, true},
...
func TestDoubleExponentialMovingAverageOutputUnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{DoubleExponentialMovingAverageValue, dqs + doubleExponentialMovingAverageValue + dqs, true},
		{zero, dqs + doubleExponentialMovingAverageUnknown + dqs, false},
