...
func TestTripleExponentialMovingAverageOutputString(t *testing.T) {
	...
	tests := []struct {
		...
		{TripleExponentialMovingAverageValue, tripleExponentialMovingAverageValue},
		{tripleExponentialMovingAverageLast, tripleExponentialMovingAverageUnknown},
		{TripleExponentialMovingAverageOutput(0), tripleExponentialMovingAverageUnknown},
		{TripleExponentialMovingAverageOutput(9999), tripleExponentialMovingAverageUnknown},
		{TripleExponentialMovingAverageOutput(-9999), tripleExponentialMovingAverageUnknown},
	}
...
func TestTripleExponentialMovingAverageOutputMarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{TripleExponentialMovingAverageValue, dqs + tripleExponentialMovingAverageValue + dqs, true},
...
func TestTripleExponentialMovingAverageOutputUnmarshalJSON(t *testing.T) {
	...
	tests := []struct {
		...
		{TripleExponentialMovingAverageValue, dqs + tripleExponentialMovingAverageValue + dqs, true},
		{zero, dqs + tripleExponentialMovingAverageUnknown + dqs, false},
